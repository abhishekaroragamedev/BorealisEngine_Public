...
public:
	...
	RenderBlendOptions m_blendOptions;
	std::vector< RenderBlendOptions > m_targetBlendOptions;	// Assumes color target options are in the same order as the targets in the FrameBuffer. Overrides default BlendOptions on the RenderState associated with this ShaderPass.
...
private:
	...
	void PopulateColorTargetBlendOptionsFromXML( const tinyxml2::XMLElement& targetsBlendElement );
