...
public:
	explicit SpriteAnimationDefinition( SpriteSheet& spriteSheet, float defaultFps, const SpriteAnimMode& playbackMode, const std::vector< int >& spriteIndices );
...
private:
	void TryPopulateIndicesFromSprites( const tinyxml2::XMLElement& spriteAnimElement, Renderer& renderer );
