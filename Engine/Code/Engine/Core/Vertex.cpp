...
const std::vector< VertexAttribute > Vertex_3DPCU::s_attributes = std::vector< VertexAttribute >(
	{
		...
		VertexAttribute( "COLOR", RendererDataType::RENDER_TYPE_UNSIGNED_INT, 4, true, offsetof( Vertex_3DPCU, m_color ) ),
...
const std::vector< VertexAttribute > Vertex_3DLit::s_attributes = std::vector< VertexAttribute >(
	{
		...
		VertexAttribute( "COLOR", RendererDataType::RENDER_TYPE_UNSIGNED_INT, 4, true, offsetof( Vertex_3DLit, m_color ) ),
